...
class ProductService implements ProductServiceContract
{
     ...
     * @return void
     */
    protected function createProduct(\App\Services\ParseVdhPizza\ParserService\Product $item): void
    {
        try {
    ...
    protected function updateProduct(Product $product, \App\Services\ParseVdhPizza\ParserService\Product $item): void
    {
